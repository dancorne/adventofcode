...
class Day2Test < Minitest::Test
  ...
  def test_colours_max
    input = [
      { 'green' => 8, 'blue' => 6, 'red' => 20 },
      { 'blue' => 4, 'red' => 4, 'green' => 13 },
      { 'green' => 5, 'red' => 1 }
    ]
    expected_output = { 'green' => 13, 'blue' => 6, 'red' => 20 }
    assert_equal expected_output, Day2.new.colours_max(input)
  end
  ...
  def test_part2
    input = <<~INPUT
      ...
      Game 5: 6 red, 1 blue, 3 green; 2 blue, 1 red, 2 green
    INPUT
    assert_equal 2286, Day2.new.part2(input)
  end
end
